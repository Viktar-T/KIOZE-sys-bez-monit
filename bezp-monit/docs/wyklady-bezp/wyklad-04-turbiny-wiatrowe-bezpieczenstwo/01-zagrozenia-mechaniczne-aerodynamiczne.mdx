...
<InstructorNotes>
**Korzeń łopaty** to obszar **największych naprężeń**, dlatego pęknięcia najczęściej tam występują. To miejsce, gdzie siły z łopaty są przenoszone do piasty, generując ekstremalne naprężenia zginające i skręcające. Punkty krytyczne obejmują również **krawędź natarcia** - najbardziej narażoną część aerodynamiczną, która przyjmuje bezpośrednie uderzenia wiatru, cząstek i kropli deszczu. **Środek ciężkości** łopaty to kolejny obszar krytyczny, gdzie koncentrują się momenty obrotowe i siły odśrodkowe. **Połączenia z piastą** to mechaniczne mocowania, które muszą wytrzymać miliony cykli obciążenia przez 20-25 lat eksploatacji.

**Zmęczenie materiałów** przez cykliczne obciążenia przez lata to główny mechanizm degradacji. Każdy obrót wirnika generuje pełny cykl obciążenia - od minimalnego w pozycji najniższej do maksymalnego w pozycji najwyższej. Przez 25 lat eksploatacji to oznacza około **200 milionów cykli** dla typowej turbiny. **Koncentracja naprężeń** w wadach konstrukcyjnych lub produkcyjnych to drugi kluczowy czynnik. Wady te mogą być wynikiem procesu produkcyjnego - pęcherzyki powietrza w żywicy, nieprawidłowe ułożenie włókien, lub wady klejenia poszczególnych komponentów łopaty.

**Mikropęknięcia** niewidoczne gołym okiem są szczególnie niebezpieczne. Mogą one powstać już podczas produkcji lub w pierwszych latach eksploatacji. W ciągu tygodni lub miesięcy mogą się propagować i doprowadzić do katastrofalnej awarii. Mechanizm propagacji jest kaskadowy - jeden mały pęknięcie koncentruje naprężenia w jego otoczeniu, co prowadzi do szybkiego wzrostu. Może to skutkować **oderwaniem fragmentów do 500kg**, które mogą być wyrzucone na odległość ponad **800 metrów** - to realne zagrożenie dla ludzi i infrastruktury w promieniu całej farmy.

**Starzenie materiału** to degradacja żywicy i włókien pod wpływem czynników środowiskowych. Promieniowanie UV, zmiany temperatury, wilgoć i sole morskie osłabiają wiązania w kompozytach. Wraz z upływem czasu materiał traci elastyczność, staje się bardziej kruchy i podatny na pękanie. To wyjaśnia, dlaczego awarie często występują w starszych turbinach, nawet jeśli początkowo nie wykazywały wad.

**Rysunek 1** pokazuje trójwymiarowy widok typowej łopaty i jej przekrój poprzeczny. Warto zwrócić uwagę studentów na złożoność konstrukcji - to nie jest jednolita struktura, ale złożony kompozyt składający się z wielu warstw, pasów nośnych (spar caps), dźwigarów (shear webs) i powłok aerodynamicznych. Każdy z tych elementów ma swoje własne punkty krytyczne i mechanizmy uszkodzeń, co wyjaśnia, dlaczego lokalizacja pęknięć jest tak zróżnicowana.

**Skutki pęknięć** są katastrofalne zarówno pod względem bezpieczeństwa, jak i ekonomicznym. **Oderwanie fragmentów** może skutkować kompletną awarią turbiny, uszkodzeniem wieży lub innych łopat. **Kosztowna naprawa** wymiany całej łopaty to zazwyczaj 150-300 tysięcy euro plus 3-4 tygodnie przestoju. Gdyby nie zostało wykryte wcześnie, katastrofalna awaria może kosztować ponad milion euro i zagrozić bezpieczeństwu całej farmy. Przejdziemy teraz do wizualizacji konkretnych przypadków i konstrukcji strukturalnej łopaty.
</InstructorNotes>
...
**Systemy kontroli** to pitch, yaw i hamulce. **Pitch** to system zmiany kąta łopatek. **Yaw** (wymowa: yaw → "jo" (like in Joga, but with a long "o")) to system zmiany orientacji turbiny względem wiatru. Te systemy reagują na zmiany warunków.

**Systemy elektryczne** z **UPS** (Uninterruptible Power Supply, czyli zasilacz awaryjny, który zapewnia krótkotrwałe zasilanie, gdy główne źródło energii zawiedzie) i redundancją zasilania gwarantują działanie nawet przy awarii sieci.
...
**Zasilanie** ma potrójną redundancję. Sieć elektryczna, **UPS** (Uninterruptible Power Supply, czyli zasilacz awaryjny, który zapewnia krótkotrwałe zasilanie, gdy główne źródło energii zawiedzie) i generatory awaryjne.
