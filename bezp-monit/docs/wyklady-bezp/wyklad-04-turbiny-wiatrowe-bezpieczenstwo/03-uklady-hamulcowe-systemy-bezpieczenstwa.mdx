...
Te przykłady pokazują **konkretne zastosowania** redundancji. **Hamulce** mają trzy poziomy (główny, awaryjny, zapasowy), **kontrolne** mają PLC główny i safety PLC, a **sensoryczne** mają wielokrotne czujniki. **3 anemometry** to standard – jeśli jeden zawiedzie, pozostałe działają. **Zasilanie** ma potrójną redundancję: sieć, **UPS** (Uninterruptible Power Supply, czyli zasilacz awaryjny, który zapewnia krótkotrwałe zasilanie, gdy główne źródło energii zawiedzie), baterie i generatory awaryjne.
</InstructorNotes>
