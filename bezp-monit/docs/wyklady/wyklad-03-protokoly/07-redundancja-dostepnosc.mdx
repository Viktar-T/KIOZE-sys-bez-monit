---
title: "Redundancja i wysoka dostępność"
sidebar_position: 7
---
...
graph TB
    subgraph "Redundancja w Systemie OZE"
        ...
        subgraph "Redundancja Komunikacyjna"
            ...
            COMM --> PROTOCOLS[Protokoły<br/>Multiple Channels]
            COMM --> CARRIERS[Nośniki<br/>LTE + Satellite]
        end
